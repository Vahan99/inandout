                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                            ...
                                                            <tr>
                                                                <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: rgb(76, 76, 76);font-size: 12px;line-height: 18px;">
                                                                    ...
                                                                    <p style="margin: 10px 0 15px 0;font-size: 15px;"><span class="orange-color">@lang('message.car-driver')</span> {{$data['driver']}}</p>
                                                                    @if(isset($data['direction']))
                                                                        <p style="margin: 10px 0 15px 0;font-size: 15px;"><span class="orange-color">@lang('message.car-direction')</span> {{$data['direction']}}</p>
                                                                    @endif
                                                                    <p style="margin: 10px 0 15px 0;font-size: 15px;"><span class="orange-color">@lang('message.duration')</span> {{ $data['duration']}}</p>

                                                                    <p style="margin: 10px 0 15px 0;font-size: 15px;"><span class="orange-color">@lang('message.starting-point')</span> {{ $data['starting_place'] }}</p>
