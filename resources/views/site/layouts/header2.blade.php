    ...
    <header>
        <div class="header-container">
            ...
            <div class="navigation-bar">
                <ul>
                    <li><a href="{{ route('view.index') }}">@lang('message.nav-home'){{--home--}}</a></li>
                    <li><a href="#">@lang('message.nav-city'){{--armenia--}}</a></li>
                    <li><a href="#">@lang('message.nav-city-home-2'){{--settlement--}}</a></li>
                    <li><a href="#">@lang('message.nav-excursion'){{--excursions--}}</a></li>
                    <li><a href="{{ route('drivers.index') }}">@lang('message.nav-traffick'){{--transport--}}</a></li>
                </ul>
            </div>
        </div>
    </header>
