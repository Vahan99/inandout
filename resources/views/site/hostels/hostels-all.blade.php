...
@section('content')
    ...
    <div id="content">
            ...
            <div class="tabs_wrapper tabs1_wrapper">
                <div class="tabs tabs2 ui-tabs ui-widget ui-widget-content ui-corner-all">
                    <div class="tabs_content tabs1_content">
                        <form action="{{ route('site.hostels-all') }}" method="get" class="form1">
                            <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="popular">
                                                <div class="popular_inner">
                                                    <figure>
                                                        <img src="/uploads/{{ $hostel->grid_image }}" alt="{{ $hostel->name }}" class="img-responsive">
                                                    </figure>
                                                    <div class="caption">
                                                        <div class="txt1"><span>{{ $hostel->name }}.</span></div>
                                                        <div class="txt2"><span class="ellipsis">{!! strip_tags($hostel->description) !!}</span></div>
                                                        <div class="txt3 clearfix">
                                                            <div class="right_side"><a href="{{ route('site.hostel-single', ['slug' => $hostel->slug]) }}" class="btn-default btn1">@lang('message.read-more')</a></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
        ...
        {{ $hostels->links('vendor.pagination.default') }}
    </div>
    </div>
@endsection