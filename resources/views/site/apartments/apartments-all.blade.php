                    ...
                    <div class="col-sm-4">
                        <div class="popular">
                          <div class="popular_inner">
                            <figure>
                              <img src="/uploads/{{ $apartment->grid_image }}" alt="{{ $apartment->name }}" class="img-responsive">
                            </figure>
                            <div class="caption">
                              <div class="txt1"><span>{{ $apartment->name }}</span></div>
                              <div class="txt2"><span class="ellipsis">{!! strip_tags($apartment->description) !!}</span></div>
                              <div class="txt3 clearfix">
                                <div class="right_side"><a href="{{ route('site.apartment-single', ['slug' => $apartment->slug]) }}" class="btn-default btn1">@lang('message.read-more')</a></div>
                              </div>
                            </div>
                          </div>
                        </div>
