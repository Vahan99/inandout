                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-md-5 booking-row">
                        ...
                        <div class="input2_wrapper">
                            ...
                            <div class="col-md-6">
                                <span class="red">
                                    <input type="text" class="form-control" value="" name="starting_place" placeholder="{{ trans('message.enter-starting-point') }}">
                                </span>
                                <div class="input-group date" id="time" >
                                    <input type="text" class="form-control" value="" name="starting_time" placeholder="{{ trans('message.starting-time') }}">
