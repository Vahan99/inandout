...
<div class="form-group">
    ...
    {!! Form::textarea('desc_en', $model ? $model->desc_en : null ,['placeholder' => 'Հայերեն:' ,'class' => 'form-control','required']); !!}
</div>
<div class="form-group">
    {{ Form::label('desc_hy', 'Description HY') }}
    {!! Form::textarea('desc_hy', $model ? $model->desc_hy : null ,['placeholder' => 'Հայերեն:' ,'class' => 'form-control','required']); !!}
</div>
<div class="form-group">
    {{ Form::label('desc_ru', 'Description RU') }}
    {!! Form::textarea('desc_ru', $model ? $model->desc_ru : null ,['placeholder' => 'Հայերեն:' ,'class' => 'form-control','required']); !!}
</div>
