$(document).ready(function() {
  ...
  {
    var classes = ['car1', 'car2', 'car3'];
    classes.forEach(function (e, i) {
        var o = $(document).find('.'+e).find('.carousel ul');
        ...
        var settings = {
            ...
            // prev: '.popular_prev',
            // next: '.popular_next',
            pagination: '#'+o.parents('.'+e).find('.popular_pagination').attr('id'),
            width: '100%',
            scroll: {
                // fx : "crossfade",
                items: 1,
        ...
        console.log(o.parents('.'+e).find('.popular_pagination').attr('id'));

        if (o.children().length > 0) {
            o.carouFredSel(settings);
        }
    });
  }
